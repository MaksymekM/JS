...
//for (const sEl of simpsons) {
//        let newDiv = document.createElement('div')
//        newDiv.classList.add('member');
//        newDiv.innerHTML = `${sEl.name} ${sEl.surname} ${sEl.age} ${sEl.info} ${sEl.photo}`;
...
//    nameDiv.innerHTML = `${sEl.name}`
//    newDiv.appendChild(nameDiv)
//    let surnameDiv = document.createElement('div')
//    surnameDiv.innerHTML = `${sEl.surname}`
//    newDiv.appendChild(surnameDiv)
//    let ageDiv = document.createElement('div')
//    ageDiv.innerHTML = `${sEl.age}`
//    newDiv.appendChild(ageDiv)
//    let infoDiv = document.createElement('div')
//    infoDiv.innerHTML = `${sEl.info}`
//    newDiv.appendChild(infoDiv)
//    let photoDiv = document.createElement('div')
//    photoDiv.innerHTML = `${sEl.photo}`
...
//    let corses = document.createElement('div')
//    let titleEl = document.createElement('h1');
//    titleEl.innerText = coursesArrayElement.title
//
//    let monthEl = document.createElement('div');
//    monthEl.innerText = coursesArrayElement.monthDuration;
//    let hourEl = document.createElement('div');
//    hourEl.innerText = coursesArrayElement.hourDuration;
//    let modulEL = document.createElement('div')
//        let modulUl = document.createElement('ul')
//            for (const modulELElement of ModulEL) {
//            let l = document.createElement('li')
//                l.innerText = modulELElement;
//                modulUl.appendChild(l)
//    }
//    modulEL.appendChild(modulUl);
//    corses.appendChild(titleEl);
//    corses.appendChild(monthEl);
//    corses.appendChild(hourEl);
//    corses.appendChild(modulEL);
//    document.body.appendChild(corses);
//}
